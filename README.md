...
A detailed analysis of the project can be found in the [report](https://github.com/OlaPietka/Gradient-Domain-Fusion/blob/main/AnalysisReport.pdf), which provides explanations, methodologies, and evaluation of the results.
